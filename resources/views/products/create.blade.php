<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p style="color: #6b7280; font-size: 14px; margin-top: 4px;">
                Add a new product with category, SKU, pricing, and stock information.
            </p>
        </div>
    </x-slot>
    ...
    <div style="max-width: 860px; margin: 0 auto; padding: 32px 24px;">
        ...
        <div style="background: white; border-radius: 16px; box-shadow: 0 8px 24px rgba(15, 23, 42, 0.07); border: 1px solid #e5e7eb; overflow: hidden;">
            ...
            <div style="padding: 22px 24px; border-bottom: 1px solid #e5e7eb; background: linear-gradient(135deg, #f0fdf4, #ffffff);">
                <h3 style="font-size: 20px; font-weight: 900; color: #111827;">
                    Product Information
                </h3>
                <p style="color: #6b7280; font-size: 14px; margin-top: 4px;">
                    Complete the form below to register a product in inventory.
                </p>
            </div>
            ...
            <div style="padding: 24px;">
                ...
                <form action="{{ route('products.store') }}" method="POST">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <button type="submit"
                                style="background: #16a34a; color: white; padding: 11px 18px; border-radius: 8px; font-weight: 800; border: none; cursor: pointer; box-shadow: 0 4px 12px rgba(22, 163, 74, 0.25);">
                            Save Product
                        </button>
                    </div>
                </form>
